...
description: >
    ...
    oglądania!
image:      "/images/covers/dsp17-prezentacja-o-migracji-bloga.png"
categories: ["timbercode"]
tags:       ["daj-sie-poznac-2017", "blog", "timbercode", "slides"]
---

![Obrazek wpisu "{{page.title}}"]( /images/covers/dsp17-prezentacja-o-migracji-bloga.png )
...
[w firmie, w której pracuję]( https://www.polidea.com/ ){:target="blank"}.
